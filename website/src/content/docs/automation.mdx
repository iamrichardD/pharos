...
### Inventory Dashboard
Use the [Pharos Console](./console) to visualize your entire hardware and software fleet. Click any node to see its deep-linkable **Identity Card**, featuring manufacturer serial numbers and specific kernel versions—essential for security audits and hardware lifecycle management.
