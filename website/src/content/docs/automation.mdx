...
### Sovereign Inventory Dashboard
Use the [Pharos Console](./console) — your lab's **Sovereign Cockpit** — to visualize your entire hardware and software fleet. Click any node to see its deep-linkable **Resource-First Identity Card**, featuring manufacturer serial numbers and specific kernel versions—essential for security audits and hardware lifecycle management.
