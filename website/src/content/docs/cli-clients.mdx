...
While the [Pharos Web Console](./console) serves as the primary **Sovereign Cockpit** and Human/AI interface, the specialized CLI clients remain the high-performance heart of the engineer's daily terminal workflow. These tools are designed for speed, scriptability, and seamless integration into your daily DevSecOps pipelines.
