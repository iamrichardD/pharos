...
| **Arch** | Linux: x86_64 only. macOS: Apple Silicon (aarch64) only — Intel Macs and Linux aarch64 (e.g. Raspberry Pi, Graviton) are not yet published as release binaries; build from source instead. |
