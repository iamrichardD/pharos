...
Pharos is built for the Agent-Sovereign era. The Console implements the **Model Context Protocol (MCP)** and **WebMCP** to allow LLMs to safely manage your lab as a first-class citizen.
