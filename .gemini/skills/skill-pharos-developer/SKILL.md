...
3.  **REFACTOR**: Clean up the code while ensuring all tests continue to pass.
    - **In-Code Rationale**: Document the purpose (the "Why") of new classes, structs, methods, or complex functions. Avoid "what" comments (self-documenting code); focus on the architectural intent.
