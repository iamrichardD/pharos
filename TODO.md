...
- [ ] **Task 105 (Issue #105):** **Filter 'unknown' inventory fields**. `pharos-pulse` sends 'unknown' for missing hardware data, cluttering mdb output. (Remediation: Omit fields with 'unknown' value in `collect_inventory`).
