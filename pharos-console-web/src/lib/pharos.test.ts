...
QyNTUxOQAAACATpDlzWOJe325A391sEOZ/LxIWc6ZzvsTRBgGQvXe3cQAAAIjeLM6D3izO
gwAAAAtzc2gtZWQyNTUxOQAAACATpDlzWOJe325A391sEOZ/LxIWc6ZzvsTRBgGQvXe3cQ
AAAEC9g9fQzP6IjBIPLVZjO/YYFItFApVw7xXp2kJ3+TnuaxOkOXNY4l7fbkDf3WwQ5n8v
EhZzpnO+xNEGAZC9d7dxAAAAAAECAwQF
-----END OPENSSH PRIVATE KEY-----`;
        ...
        dataHandler(Buffer.from('Pharos Protocol v1.0\n'));
        dataHandler(Buffer.from('200:ID:Accepted\n'));
        expect(mockSocket.write).toHaveBeenCalledWith('add test=openssh\r\n');
        ...
        // If it got here without throwing DECODER routines::unsupported, it succeeded in parsing
        expect(crypto.sign).toHaveBeenCalled();
