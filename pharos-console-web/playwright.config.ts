...
export default defineConfig({
  ...
  webServer: [
    {
      command: 'PHAROS_SANDBOX=true PHAROS_SKIP_AUTH=true PHAROS_SERVER_URL=https://127.0.0.1:2378 PHAROS_HOST=127.0.0.1 PHAROS_PORT=2378 HOST=0.0.0.0 PORT=3000 node test-server.mjs',
